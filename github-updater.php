<?php
/**
 * GitHub Update Checker for GP Beaver Integration
 *
...
class GPBI_GitHub_Updater {
    private $file;
    private $plugin;
    private $basename;
    private $github_response;
    private $github_username = "weavedigitalstudio";
    private $github_repo = "gp-beaver-integration";
    ...
    public function check_update($transient) {
        ...
        if (defined('WP_DEBUG') && WP_DEBUG) {
            error_log("GPBI GitHub Updater - Current version: {$current_version_normalized}, Latest version: {$latest_version}");
        }
    ...
    public function plugin_info($res, $action, $args) {
        ...
        $info->sections = [
            "description" => $plugin_data["Description"] ?? "Integrates GeneratePress with Beaver Builder for consistent branding by synchronizing colors and fonts.",
